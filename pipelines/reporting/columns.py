...
DEAL_COLUMNS = [
    ...
    "has_relevant_crm_comment",
    "has_next_step_activity",
    "next_step_activity_has_comment",
    "next_step_activity_not_overdue",
    "next_step_activity_summary",
    "alignment_score",
    "crm_work_score",
    ...
    "deal_stage_progress_summary",
    "bitrix_summary_sources",
    "calls_breakdown",
    "improvement_moments_combined",
]

# Колонки для листа "Сводка_BitrixGPT"
