...
RU_COLUMNS: dict[str, str] = {
    ...
    "conversion_report_section": "Раздел конверсии",
    "manager_issue_type": "Тип проблемы",
    "manager_issue_detail": "Деталь проблемы",
    "event_type": "Тип события",
    "event_detail": "Описание события",
    ...
    "has_comments": "Комментарий CRM засчитан",
    "has_relevant_crm_comment": "Комментарий соответствует звонку",
    "crm_comment_matches_call": "Комментарий соответствует звонку",
    "crm_comment_match_text": "Комментарий, связанный со звонком",
    "has_next_step_activity": "Создан следующий шаг/дело",
    "next_step_activity_has_comment": "Комментарий в деле",
    "next_step_activity_not_overdue": "Срок дела актуален",
    "next_step_activity_summary": "Следующее дело в CRM",
    "deal_quality_short_call_mode": "Короткий звонок без разговора",
    ...
    "checklist_block_name": "Блок чек-листа",
    ...
    "criterion_fail_rate": "Доля проблем критерия, %",
    ...
    "bitrix_chat_summary": "Резюме чата (BitrixGPT)",
    "bitrix_call_summary": "Резюме звонка (BitrixGPT/Bitrix)",
    "bitrix_combined_summary": "Общий смысл по резюме Bitrix",
    "bitrix_overall_meaning": "Общий смысл (комментарии+активности Bitrix)",
    "bitrix_summary_sources": "Источники резюме Bitrix",
    "bitrix_summary_found": "Резюме Bitrix найдено",
    "deal_stage_progress_summary": "Текущая стадия и проработка",
    ...
    "script_gap_rate": "Доля проблем скрипта, %",
