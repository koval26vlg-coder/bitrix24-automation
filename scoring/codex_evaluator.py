...
class CodexEvaluator:
    ...
    async def evaluate_transcript(
        self, transcript: str, deal_context: dict[str, Any]
    ) -> dict[str, Any]:
        """
        ...
        try:
            ...
            result = {
                ...
                "codex_summary": "Менеджер уверенно ведет диалог, но требуется доработка в блоке аргументации цены.",  # noqa: E501
                "codex_pros": "Соблюдение регламента приветствия, проактивность в выявлении болей клиента.",  # noqa: E501
                "codex_cons": "Слабая работа с возражением «дорого», отсутствие четкого дедлайна по следующему шагу.",  # noqa: E501
                "codex_recommendations": "Использовать технику сэндвича при озвучивании стоимости. Назначить точное время звонка.",  # noqa: E501
