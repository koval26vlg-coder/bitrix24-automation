...
from pipelines.scoring import evaluate_call_checklist, _objection_matches
...
def test_compute_deal_quality():
    ...
    kpi = {"deal_quality_weights": {"has_contact": 25, "has_amount": 25, "has_title": 25, "has_comments": 25}}
...
def test_compute_discipline_metrics():
    ...
    calls = [
        {"START_TIME": "2026-05-01T10:10:00+03:00"}
    ]
